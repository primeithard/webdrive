...
<ui:templete>
    ...
    <jsp:attribute name="body_area">
        ...
        <section class="dashboard-counts no-padding-bottom center">
			...
			<img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" title="Авторизация" onclick="location.href = '${pageContext.request.contextPath}/api/oauth/google/redirect'"><br><br><br>
        ...
        <header class="page-header">
            <div class="container-fluid">
                <h2 class="no-margin-bottom">Панель управления</h2>
            </div>
        </header>
