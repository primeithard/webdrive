    ...
    <jsp:attribute name="body_area">
        ...
        <section class="dashboard-counts no-padding-bottom center">
            <div class="container-fluid">
                <div class="row bg-white has-shadow">
	                ...
	                <p style="font-size: 20px; color: #ed3424">Необходимо авторизоваться</p>
			<img src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" title="Авторизация Google" onclick="location.href = '${pageContext.request.contextPath}/api/oauth/google/redirect'"><br><br><br>
        ...
        <ul class="breadcrumb">
            <div class="container-fluid">
                ...
                <li class="breadcrumb-item active">Новая загрузка</li>
            </div>
        </ul>
          <!-- Forms Section-->
          <section class="forms">
                                  ...
                                  <form method="post" id="uploadform" action="${pageContext.request.contextPath}/api/drive/upload">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" id="filename" name="filename"
                                                 ...
                                                 class="form-control">
                                          <span class="help-block-none">Имя файла не обязательно.</span>
                                      </div>
